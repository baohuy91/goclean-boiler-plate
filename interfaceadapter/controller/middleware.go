...
type Mdw interface {
	...
	// Parse token for JWT request, implement your authentication here
	Token(controller func(w http.ResponseWriter, r *http.Request, context Context)) http.Handler
	// Log to log file
...
func (m *mdwImpl) Token(controller func(w http.ResponseWriter, r *http.Request, context Context)) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
